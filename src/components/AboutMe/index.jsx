        ...
        <div className="aboutMe">
          ...
          <div className="aboutMeContent">
            <p className="aboutMeItems tracking-widest md:text-lg sm:text-sm">
              I'm a young man, passionate about technology and solving real-world problems through coding.
            </p>
            <p className="aboutMeItems tracking-widest md:text-lg sm:text-sm">
            From a young age, I have been curious about understanding how things work, which led me to explore the world of technology. Today, I dedicate my time to learning, creating, and growing as a <b className="text-blue-400">data analytics and process automation</b>, as well as venturing into the fields of <b className="text-blue-400">software developing.</b> With every project, I see an opportunity to transform ideas into impactful solutions.
            </p>
            <p className="aboutMeItems tracking-widest md:text-lg sm:text-sm">
